...
import {
    ...
    AddressInputToJSON,
    ForeignAddressInput,
    ForeignAddressInputFromJSON,
    ForeignAddressInputFromJSONTyped,
    ForeignAddressInputToJSON,
} from '.';
...
export interface CompanyInput {
    /**
     * The Finnish Business ID - Y-tunnus.
     * @type {string}
     * @memberof CompanyInput
     */
    BusinessId?: string | null;
    /**
     * A foreign business ID if the company is a foreign company that does not operate under a Finnish company with a Y-tunnus. Alternative to BusinessId. Only one of either BusinessId or ForeignBusinessId should be sent.
     * @type {string}
     * @memberof CompanyInput
     */
    ForeignBusinessId?: string | null;
    /**
     * If the organization is not a company, but some other organization without a business id (e.g. hoitokunta, osakaskunta). Alternative to BusinessId and ForeignBusinessId. Only one of either BusinessId, ForeignBusinessId or IsOrganizationWithoutBusinessId should be sent. Currently only allowed for waste holder companies.
     * @type {boolean}
     * @memberof CompanyInput
     */
    IsOrganizationWithoutBusinessId: boolean;
    /**
     * Name of the company
     * @type {string}
     * @memberof CompanyInput
    ...
    /**
     * 
     * @type {ForeignAddressInput}
     * @memberof CompanyInput
     */
    ForeignAddress: ForeignAddressInput;
}
...
export function CompanyInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyInput {
    ...
    return {
        ...
        'ForeignBusinessId': !exists(json, 'foreignBusinessId') ? undefined : json['foreignBusinessId'],
        'IsOrganizationWithoutBusinessId': json['isOrganizationWithoutBusinessId'],
        'Name': json['name'],
        'Address': AddressInputFromJSON(json['address']),
        'ForeignAddress': ForeignAddressInputFromJSON(json['foreignAddress']),
    };
}
...
export function CompanyInputToJSON(value?: CompanyInput | null): any {
    ...
    return {
        ...
        'foreignBusinessId': value.ForeignBusinessId,
        'isOrganizationWithoutBusinessId': value.IsOrganizationWithoutBusinessId,
        'name': value.Name,
        'address': AddressInputToJSON(value.Address),
        'foreignAddress': ForeignAddressInputToJSON(value.ForeignAddress),
    };
}
