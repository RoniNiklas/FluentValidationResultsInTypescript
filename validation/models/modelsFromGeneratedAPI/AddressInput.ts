...
/**
 * Address of the location (Toimipaikka tai kotitalous).
 * @export
 * @interface AddressInput
 */
export interface AddressInput {
    /**
     * The street address of the location (Toimipaikka tai kotitalous). Required if the site has no coordinates.
     * @type {string}
     * @memberof AddressInput
     */
    StreetAddress: string;
    /**
     * The postal code of the location (Toimipaikka tai kotitalous). Required if the site has no coordinates.
     * @type {string}
     * @memberof AddressInput
     */
    PostalCode: string;
