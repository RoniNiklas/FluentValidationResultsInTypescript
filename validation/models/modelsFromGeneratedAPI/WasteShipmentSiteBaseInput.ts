...
/**
 * Information about the waste site
 * @export
 * @interface WasteShipmentSiteBaseInput
 */
export interface WasteShipmentSiteBaseInput {
    /**
     * 
     * @type {AddressInput}
     * @memberof WasteShipmentSiteBaseInput
     */
...
export function WasteShipmentSiteBaseInputFromJSON(json: any): WasteShipmentSiteBaseInput {
    return WasteShipmentSiteBaseInputFromJSONTyped(json, false);
}

export function WasteShipmentSiteBaseInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): WasteShipmentSiteBaseInput {
...
export function WasteShipmentSiteBaseInputToJSON(value?: WasteShipmentSiteBaseInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
