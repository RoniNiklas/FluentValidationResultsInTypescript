...
export interface LocationInput {
    /**
     * Latitute of the site. Required if the site has no address.
     * @type {number}
     * @memberof LocationInput
     */
    Latitude: number;
    /**
     * Longitude of the site. Required if the site has no address.
     * @type {number}
     * @memberof LocationInput
     */
    Longitude: number;
    /**
     * The BusinessId of the municipality the coordinates are located in. Required if the site has no address.
     * @type {string}
     * @memberof LocationInput
     */
    MunicipalityBusinessId: string;
}
...
export function LocationInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationInput {
    ...
    return {
        ...
        'MunicipalityBusinessId': json['municipalityBusinessId'],
    };
}
...
export function LocationInputToJSON(value?: LocationInput | null): any {
    ...
    return {
        ...
        'municipalityBusinessId': value.MunicipalityBusinessId,
    };
}
