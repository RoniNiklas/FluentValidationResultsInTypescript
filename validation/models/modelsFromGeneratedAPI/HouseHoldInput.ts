...
/**
 * Required if the waste producer is a household. Leave empty if waste producer is company.
 * @export
...
export function HouseHoldInputFromJSON(json: any): HouseHoldInput {
    return HouseHoldInputFromJSONTyped(json, false);
}

export function HouseHoldInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): HouseHoldInput {
...
export function HouseHoldInputToJSON(value?: HouseHoldInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
