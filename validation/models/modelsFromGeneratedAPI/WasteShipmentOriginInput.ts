...
/**
 * Start location of the waste shipment.
 * @export
 * @interface WasteShipmentOriginInput
 */
export interface WasteShipmentOriginInput {
    /**
     * 
     * @type {AddressInput}
     * @memberof WasteShipmentOriginInput
     */
    ...
    /**
     * The identifier of the related building (Pysyvä rakennustunnus), if available.
     * Either this or PropertyIdentifier is required after 1.1.2023 when the LoWCode of a waste is 200304 (lietejätettä)
     * @type {string}
     * @memberof WasteShipmentOriginInput
     */
    PermanentBuildingNumber?: string | null;
    /**
     * The identifier of the related property (Kiinteistötunnus), if available.
     * Either this or PermanentBuildingNumber is required after 1.1.2023 when the LoWCode of a waste is 200304 (lietejätettä)
     * @type {string}
     * @memberof WasteShipmentOriginInput
     */
    PropertyIdentifier?: string | null;
    /**
     * The reason why a PermanentBuildingNumber or PropertyIdentifier is not provided when it is required (LoWCode 200304). Usually related to construction sites.
     * @type {string}
     * @memberof WasteShipmentOriginInput
     */
    ReasonForNoIdentifier?: string | null;
}

export function WasteShipmentOriginInputFromJSON(json: any): WasteShipmentOriginInput {
    return WasteShipmentOriginInputFromJSONTyped(json, false);
}

export function WasteShipmentOriginInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): WasteShipmentOriginInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {

        'Address': AddressInputFromJSON(json['address']),
        'Location': LocationInputFromJSON(json['location']),
        'PermanentBuildingNumber': !exists(json, 'permanentBuildingNumber') ? undefined : json['permanentBuildingNumber'],
        'PropertyIdentifier': !exists(json, 'propertyIdentifier') ? undefined : json['propertyIdentifier'],
        'ReasonForNoIdentifier': !exists(json, 'reasonForNoIdentifier') ? undefined : json['reasonForNoIdentifier'],
    };
}

export function WasteShipmentOriginInputToJSON(value?: WasteShipmentOriginInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'address': AddressInputToJSON(value.Address),
        'location': LocationInputToJSON(value.Location),
        'permanentBuildingNumber': value.PermanentBuildingNumber,
        'propertyIdentifier': value.PropertyIdentifier,
        'reasonForNoIdentifier': value.ReasonForNoIdentifier,
    };
}
