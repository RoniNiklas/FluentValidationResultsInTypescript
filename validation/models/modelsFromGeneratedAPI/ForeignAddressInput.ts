 ...
 */
export interface ForeignAddressInput {
    /**
     * Country by its ISO 3166-1 Alpha-2 Code. E.g. EE = Estonia
     * @type {string}
     * @memberof ForeignAddressInput
     */
    CountryISO2: string;
    /**
     * The address and the region identification (postal codes, zip codes etc) of the address.
     * @type {string}
     * @memberof ForeignAddressInput
     */
    AddressField: string;
...
export function ForeignAddressInputFromJSON(json: any): ForeignAddressInput {
    return ForeignAddressInputFromJSONTyped(json, false);
}

export function ForeignAddressInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForeignAddressInput {
...
export function ForeignAddressInputToJSON(value?: ForeignAddressInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
