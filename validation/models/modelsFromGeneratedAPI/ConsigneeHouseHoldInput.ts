...
/**
 * Required if the waste receiver is a household. Leave empty if the waste receiver is a company.
 * @export
 * @interface ConsigneeHouseHoldInput
 */
export interface ConsigneeHouseHoldInput {
    /**
     * 
     * @type {AddressInput}
     * @memberof ConsigneeHouseHoldInput
     */
    ...
    /**
     * The Id of the site in their MARA-application (MARA-ilmoituksen kohde id) if the consignee is MARA registered.
     * @type {string}
     * @memberof ConsigneeHouseHoldInput
     */
    MaraId?: string | null;
...
export function ConsigneeHouseHoldInputFromJSON(json: any): ConsigneeHouseHoldInput {
    return ConsigneeHouseHoldInputFromJSONTyped(json, false);
}

export function ConsigneeHouseHoldInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsigneeHouseHoldInput {
    ...
    return {
        ...
        'MaraId': !exists(json, 'maraId') ? undefined : json['maraId'],
    };
}

export function ConsigneeHouseHoldInputToJSON(value?: ConsigneeHouseHoldInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
